...
assert_quoted \
  "$OUTPUT_DIR/gemini-cli/skills/engineering-developer-tooling-engineer/SKILL.md" \
  description
assert_quoted \
  "$OUTPUT_DIR/opencode/agents/engineering-developer-tooling-engineer.md" \
  name
assert_quoted \
  "$OUTPUT_DIR/opencode/agents/engineering-developer-tooling-engineer.md" \
  description
assert_quoted \
  "$OUTPUT_DIR/qwen/agents/paid-media-programmatic-buyer.md" \
  name
assert_quoted \
  "$OUTPUT_DIR/qwen/agents/paid-media-programmatic-buyer.md" \
  description
